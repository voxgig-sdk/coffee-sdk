# Coffee SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CoffeeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CoffeeSDK(...) and CoffeeSDK.test(...) become
#      CoffeeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "coffee_sdk"
_SDK_CLASS = "CoffeeSDK"
