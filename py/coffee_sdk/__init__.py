...
from coffee_sdk.utility import register

# Load features
from coffee_sdk.feature.base_feature import CoffeeBaseFeature
from coffee_sdk.features import _has_feature, _make_feature
...
class CoffeeSDK:
    ...
    def get_utility(self):
        return CoffeeUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CoffeeSDK: graphql: " + str(msg))
            res["graphql"] = errors
