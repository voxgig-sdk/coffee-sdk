...
from coffee_sdk.core.control import CoffeeControl
...
from coffee_sdk.core.helpers import get_ctx_prop, to_map
...
class CoffeeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, CoffeeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CoffeeError(code, msg, self)
