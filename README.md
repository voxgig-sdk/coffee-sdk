...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/coffee` | `npm install @voxgig-sdk/coffee` |
| Python | `voxgig-sdk-coffee` | `pip install voxgig-sdk-coffee` |
| PHP | `voxgig-sdk/coffee` | `composer require voxgig-sdk/coffee` |
| Golang | `github.com/voxgig-sdk/coffee-sdk/go` | `go get github.com/voxgig-sdk/coffee-sdk/go` |
| Ruby | `voxgig-sdk-coffee` | `gem install voxgig-sdk-coffee` |
| Lua | `voxgig-sdk-coffee` | `luarocks install voxgig-sdk-coffee` |
