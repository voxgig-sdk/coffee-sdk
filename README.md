...
Learn more about Coffee at [sampleapis.com/api-list/coffee](https://sampleapis.com/api-list/coffee).
...
This SDK exposes the API as a small set of **semantic entities** — Hot and Iced — that you
...
const items = await client.Hot().list()
```
...
```go
client := sdk.Test()
result, err := client.Hot(nil).List(
    nil, nil,
)
```
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/coffee-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/coffee-sdk/tags) |
| Python | `voxgig-sdk-coffee` | publish pending — [install from git tag](https://github.com/voxgig-sdk/coffee-sdk/tags) |
| PHP | `voxgig-sdk/coffee` | publish pending — [install from git tag](https://github.com/voxgig-sdk/coffee-sdk/tags) |
| Golang | `github.com/voxgig-sdk/coffee-sdk/go` | `go get github.com/voxgig-sdk/coffee-sdk/go@latest` |
| Ruby | `voxgig-sdk-coffee` | publish pending — [install from git tag](https://github.com/voxgig-sdk/coffee-sdk/tags) |
| Lua | `voxgig-sdk-coffee` | publish pending — [install from git tag](https://github.com/voxgig-sdk/coffee-sdk/tags) |
| Go CLI | `github.com/voxgig-sdk/coffee-sdk/go-cli` | `go install github.com/voxgig-sdk/coffee-sdk/go-cli/cmd/coffee@latest` |
| Go MCP server | `github.com/voxgig-sdk/coffee-sdk/go-mcp` | `go get github.com/voxgig-sdk/coffee-sdk/go-mcp@latest` |
...
$hots = $client->Hot()->list();
print_r(array_map(fn($item) => $item->data_get(), $hots));
```
