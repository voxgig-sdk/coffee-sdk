...
class IcedEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IcedEntity($this->_client, $opts);
    }

    /**
     * @param Iced|array $args Iced data (assoc-array) to store.
     */
    ...
    /**
     * @return Iced|array The current Iced data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Iced fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Iced fields).
     */
     ...
     *
     * @param IcedListMatch|array|null $reqmatch Match filter (any subset
     *   of Iced fields) as an assoc-array; IcedListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Iced[]|array A list of Iced items as assoc-arrays at
