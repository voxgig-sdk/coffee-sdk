...
class HotDirectTest extends TestCase
{
    public function test_direct_list_hot(): void
    {
        $setup = hot_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-hot", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
