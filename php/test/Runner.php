...
class CoffeeTestRunner
{
    ...
    {
        $live = self::getenv('COFFEE_TEST_LIVE');
        $override = self::getenv('COFFEE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('COFFEE_TEST_EXPLAIN');
...
class_alias('CoffeeTestRunner', 'Runner');
class_alias('CoffeeHelpers', 'Helpers');
