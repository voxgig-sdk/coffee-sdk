...
class IcedDirectTest extends TestCase
{
    public function test_direct_list_iced(): void
    {
        $setup = iced_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-iced", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
