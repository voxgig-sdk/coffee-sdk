...
// Coffee SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CoffeeSDK::test)
...
{
    private const SDK_CLASS = 'CoffeeSDK';
    ...
    private const SDK_BASE = 'coffee_sdk';
