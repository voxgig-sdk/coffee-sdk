...
The PHP SDK for the Coffee API — an entity-oriented client using PHP conventions.
...
$hot = $client->Hot()->list();
print_r(array_map(fn($item) => $item->data_get(), $hot));
```
...
The main class (`coffee_sdk.php`) exports the SDK class
