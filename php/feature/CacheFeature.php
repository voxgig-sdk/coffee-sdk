...
class CoffeeCacheFeature extends CoffeeBaseFeature
{
    ...
    private function _through(CoffeeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
