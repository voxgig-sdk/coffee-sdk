...
class CoffeeStreamingFeature extends CoffeeBaseFeature
{
    ...
    private function _iterate(CoffeeResult $result): \Generator
    {
    ...
    private function _streamable(CoffeeContext $ctx): bool
    {
