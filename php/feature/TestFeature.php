...
// Coffee SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CoffeeTestFeature extends CoffeeBaseFeature
{
    ...
    public function init(CoffeeContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CoffeeContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CoffeeContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CoffeeContext $ctx, $op, $args): array
    {
