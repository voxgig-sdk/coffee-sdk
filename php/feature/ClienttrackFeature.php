...
// Coffee SDK clienttrack feature
...
class CoffeeClienttrackFeature extends CoffeeBaseFeature
{
    ...
    public function PostConstruct(CoffeeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Coffee-SDK';
