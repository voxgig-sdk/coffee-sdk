...
class CoffeeProxyFeature extends CoffeeBaseFeature
{
    ...
    public function init(CoffeeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CoffeeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
