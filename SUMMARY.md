...
| --- | --- | --- | --- |
| Hot | `list` | `GET /coffee/hot` | See reference |
| Iced | `list` | `GET /coffee/iced` | See reference |
...
- `coffee_list`: List records for an entity. Supported entities: `hot`, `iced`.
- `coffee_load`: Load one record for an entity. No active entity supports this operation.
