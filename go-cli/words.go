...
func registerSDKWords(r *eng.Registry, client *sdk.CoffeeSDK) {
...
func runOp(client *sdk.CoffeeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
