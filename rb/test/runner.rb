...
module CoffeeTestRunner
  ...
  def self.env_override(m)
    live = getenv("COFFEE_TEST_LIVE")
    override = getenv("COFFEE_TEST_OVERRIDE")
    ...
    explain = getenv("COFFEE_TEST_EXPLAIN")
    m["COFFEE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
