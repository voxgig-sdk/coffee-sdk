...
class IcedEntity
  ...
  #
  # @param reqmatch [IcedListMatch, Hash, nil] match filter (any subset of
  #   Iced fields); defaults to nil, treated as an empty match that lists all.
