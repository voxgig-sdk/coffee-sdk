...
describe("HotDirect", function()
  it("should direct-list-hot", function()
    local setup = hot_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-hot", setup.live and "live" or "unit")
...
function hot_direct_setup(mockres)
