...
describe("IcedDirect", function()
  it("should direct-list-iced", function()
    local setup = iced_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-iced", setup.live and "live" or "unit")
...
function iced_direct_setup(mockres)
