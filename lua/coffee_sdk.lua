...
CoffeeSDK._make_feature = _make_feature


function CoffeeSDK.new(options)
  local self = setmetatable({}, CoffeeSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function CoffeeSDK:options_map()
...
function CoffeeSDK:get_utility()
  return Utility.copy(self._utility)
end


function CoffeeSDK:get_root_ctx()
  return self._rootctx
end


function CoffeeSDK:prepare(fetchargs)
...
function CoffeeSDK:direct(fetchargs)
...
-- by passing it.
function CoffeeSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function CoffeeSDK:graphql(query, variables, ctrl)
...
function CoffeeSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = CoffeeSDK.new(sdkopts)
  sdk.mode = "test"
