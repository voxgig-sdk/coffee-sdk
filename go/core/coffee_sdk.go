...
func (sdk *CoffeeSDK) OptionsMap() map[string]any {
...
func (sdk *CoffeeSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *CoffeeSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *CoffeeSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CoffeeSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *CoffeeSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *CoffeeSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("CoffeeSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *CoffeeSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CoffeeSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("CoffeeSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
