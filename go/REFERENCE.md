# Coffee Golang SDK Reference

Complete API reference for the Coffee Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *CoffeeSDK`
...
#### `Hot(data map[string]any) CoffeeEntity`

Create a new `Hot` entity instance. Pass `nil` for no initial data.

#### `Iced(data map[string]any) CoffeeEntity`

Create a new `Iced` entity instance. Pass `nil` for no initial data.
