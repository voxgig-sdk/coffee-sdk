...
const testSeed = `map[string]any{"entity": map[string]any{"hot": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "iced": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
