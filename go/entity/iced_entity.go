...
import (
	...
	vs "github.com/voxgig-sdk/coffee-sdk/go/utility/struct"
)

type IcedEntity struct {
	name    string
	client  *core.CoffeeSDK
...
func NewIcedEntity(client *core.CoffeeSDK, entopts map[string]any) *IcedEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IcedEntity) GetName() string { return e.name }
...
func (e *IcedEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IcedEntity) Deleted() bool {
	return e.deleted
}


func (e *IcedEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIcedEntity(e.client, opts)
}

func (e *IcedEntity) Data(args ...any) any {
...
func (e *IcedEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Iced; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IcedEntity) DataTyped(data ...Iced) Iced {
	if len(data) > 0 {
		return typedFrom[Iced](e.Data(asMap(data[0])))
	}
	return typedFrom[Iced](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Iced (all fields
// optional at the wire level).
func (e *IcedEntity) MatchTyped(match ...Iced) Iced {
	if len(match) > 0 {
		return typedFrom[Iced](e.Match(asMap(match[0])))
	}
	return typedFrom[Iced](e.Match())
}
...
func (e *IcedEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IcedEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *IcedEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IcedListMatch and returns []Iced. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *IcedEntity) ListTyped(reqmatch IcedListMatch, ctrl map[string]any) ([]Iced, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Iced](res), nil
}



func (e *IcedEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IcedEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IcedEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IcedEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
