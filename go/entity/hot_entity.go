...
func NewHotEntity(client *core.CoffeeSDK, entopts map[string]any) *HotEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HotEntity) GetName() string { return e.name }
...
func (e *HotEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HotEntity) Deleted() bool {
	return e.deleted
}


func (e *HotEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHotEntity(e.client, opts)
}

func (e *HotEntity) Data(args ...any) any {
...
func (e *HotEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Hot; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *HotEntity) DataTyped(data ...Hot) Hot {
	if len(data) > 0 {
		return typedFrom[Hot](e.Data(asMap(data[0])))
	}
	return typedFrom[Hot](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Hot (all fields
// optional at the wire level).
func (e *HotEntity) MatchTyped(match ...Hot) Hot {
	if len(match) > 0 {
		return typedFrom[Hot](e.Match(asMap(match[0])))
	}
	return typedFrom[Hot](e.Match())
}
...
func (e *HotEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HotEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *HotEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// HotListMatch and returns []Hot. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *HotEntity) ListTyped(reqmatch HotListMatch, ctrl map[string]any) ([]Hot, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Hot](res), nil
}



func (e *HotEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *HotEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *HotEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HotEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
