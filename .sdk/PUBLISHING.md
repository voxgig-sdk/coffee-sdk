...
|---|---|---|
| `ts/` | @voxgig-sdk/coffee-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/coffee-sdk \
      --repository voxgig-sdk/coffee-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/coffee-sdk` shows it, and
`npm trust revoke @voxgig-sdk/coffee-sdk --id=<id>` removes it.
