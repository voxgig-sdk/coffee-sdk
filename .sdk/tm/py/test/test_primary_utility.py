...
from projectname_sdk import CoffeeSDK
from projectname_sdk.core.spec import CoffeeSpec
from projectname_sdk.core.result import CoffeeResult
from projectname_sdk.core.response import CoffeeResponse
from projectname_sdk.core.operation import CoffeeOperation
from projectname_sdk.core.error import CoffeeError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import CoffeeBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = CoffeeSDK.test(None, None)
        ...
        class TestInitFeature(CoffeeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(CoffeeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = CoffeeSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = CoffeeSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = CoffeeSDK.test(None, setup_opts)
