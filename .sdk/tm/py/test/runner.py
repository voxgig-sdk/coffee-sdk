...
class CoffeeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CoffeeTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = CoffeeTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = CoffeeTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
