...
// Coffee SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CoffeeMakeRequest
{
    public static function call(CoffeeContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CoffeeResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CoffeeResponse($fetched);
        } else {
