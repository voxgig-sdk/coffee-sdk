...
class CoffeeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CoffeeSDK/1.0)';
    ...
    public static function call(CoffeeContext $ctx, string $fullurl, array $fetchdef): array
    {
