...
// Coffee SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CoffeeOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CoffeeOmni::structfix($now, Struct::undef()))
                        !== json_encode(CoffeeOmni::structfix($val, Struct::undef()))) {
