...
class CoffeeNetsimFeature extends CoffeeBaseFeature
{
    ...
    private function _simulate(CoffeeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CoffeeContext $ctx, array $applied): void
    {
        $client = $this->client;
