...
class CoffeeRatelimitFeature extends CoffeeBaseFeature
{
    ...
    private function _acquire(CoffeeContext $ctx): void
    {
    ...
    private function _track(CoffeeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
