...
class CoffeeRbacFeature extends CoffeeBaseFeature
{
    ...
    private function _required(CoffeeContext $ctx): ?string
    {
    ...
    private function _reject(CoffeeContext $ctx, string $required): void
    {
    ...
    private function _track(CoffeeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
