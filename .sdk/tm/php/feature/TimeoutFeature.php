...
class CoffeeTimeoutFeature extends CoffeeBaseFeature
{
    ...
    private function _with_timeout(CoffeeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CoffeeContext $_ctx, float $ms): void
    {
        $client = $this->client;
