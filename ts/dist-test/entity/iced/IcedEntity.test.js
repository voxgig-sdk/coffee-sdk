...
(0, node_test_1.describe)('IcedEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'iced.' + op, live))
                return;
        }
        ...
        let iced_ref01_data = Object.values(setup.data.existing.iced)[0];
        // LIST
        const iced_ref01_ent = client.Iced();
        const iced_ref01_match = {};
        const iced_ref01_list = (await iced_ref01_ent.list(iced_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/iced/IcedTestData.json');
    ...
    let idmap = transform(['iced01', 'iced02', 'iced03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=IcedEntity.test.js.map