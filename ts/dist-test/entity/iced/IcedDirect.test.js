...
(0, node_test_1.describe)('IcedDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-iced', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-iced', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.COFFEE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CoffeeSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['COFFEE_TEST_ICED_ENTID'];
    ...
    const client = new __1.CoffeeSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=IcedDirect.test.js.map