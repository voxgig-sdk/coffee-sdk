# Coffee TypeScript SDK



The TypeScript SDK for the Coffee API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Hot()` — each with a small set of operations (`list`)
...
| `tester(testopts?, sdkopts?)` | `CoffeeSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `CoffeeSDK.test(testopts?, sdkopts?)` | `CoffeeSDK` | Create a test-mode client. |
...
| `client` | `client(): CoffeeSDK` | Return the parent SDK client. |
