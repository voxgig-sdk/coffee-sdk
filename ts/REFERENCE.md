# Coffee TypeScript SDK Reference

Complete API reference for the Coffee TypeScript SDK.
...
#### `CoffeeSDK.test(testopts?, sdkopts?)`
...
**Returns:** `CoffeeSDK` instance in test mode.
...
Create a new `Iced` entity instance.
...
Return the parent `CoffeeSDK` instance.
