...
type Args struct {
	Entity string         `json:"entity" jsonschema:"hot | iced"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CoffeeSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "coffee_list",
		Description: "List records from Coffee. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "coffee_load",
		Description: "Load a single record from Coffee. " +
...
func runOp(client *sdk.CoffeeSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CoffeeSDK, name string) (sdk.CoffeeEntity, error) {
	switch strings.ToLower(name) {
	case "hot":
		return client.Hot(nil), nil
	case "iced":
		return client.Iced(nil), nil
